...
<body>
  <div class="container">
    ...
    <form action="order" method="post">
        ...
        <input type="text" id="userId" placeholder="사용자 ID 입력" required/>

        <label for="productName">상품명</label>
        <input type="text" id="productName" placeholder="상품명 입력" required/>

        <label for="amount">수량</label>
        <input type="number" id="amount" placeholder="수량 입력" required/>
